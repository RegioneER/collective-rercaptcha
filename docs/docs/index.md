...
myst:
  html_meta:
    "description": "Integration with rercaptcha in Plone"
    "property=og:description": "Integration with rercaptcha in Plone"
    "property=og:title": "collective-rercaptcha"
    "keywords": "collective-rercaptcha, documentation, Integration with rercaptcha in Plone"
---

# collective-rercaptcha

Welcome to the documentation for collective-rercaptcha!
