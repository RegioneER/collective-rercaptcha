...
const View: React.FC<CaptchaTestViewProps> = (props) => {
  ...
  return (
    <div
      className="captcha-test-block-view"
      style={{
        padding: '20px',
    ...
    >
      ...
      <p style={{ fontSize: '0.95em' }}>
        Questo blocco carica un componente <strong>RerCapWidget</strong> che
        esegue un calcolo Proof of Work (SHA-256) in background tramite
        WebWorkers.
      </p>
      ...
      >
        <p style={{ margin: '0 0 10px 0' }}>
          <strong>Stato Esecuzione:</strong>{' '}
          <span style={{ color: token ? '#21ba45' : '#4183c4' }}>{status}</span>
        </p>
        {token && (
          <p style={{ margin: 0 }}>
